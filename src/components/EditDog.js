            ...
            <div>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group controlId="editDogName">
                        ...
                        <Form.Control name="name" type="input" defaultValue={this.state.name} onChange={this.handleChange}/>
                    </Form.Group>
                    <Form.Group controlId="editDogAge">
                        <Form.Label>Dog's Age</Form.Label>
                        <Form.Control name="age" type="input" defaultValue={this.state.age} onChange={this.handleChange} />
                    </Form.Group>
                    ...
                    <Form.Group controlId="editDogBreed">
                        ...
                        <Form.Control name="breed" type="input" defaultValue={this.state.breed} onChange={this.handleChange} placeholder="example:  Golden Retriever"/>
                    </Form.Group>
                    <Form.Group controlId="editDogNotes">
                        <Form.Label>Notes</Form.Label>
                        <Form.Control name="notes" as="textarea" rows={3} defaultValue={this.state.notes} onChange={this.handleChange} placeholder="example:  Sparky is aggressive toward other dogs." />
                    </Form.Group>
